...
if(isset($_POST['resetPassword']) ){
    $username = "root";
    $password = "";
    $database = new PDO("mysql:host=localhost; dbname=swah;",$username,$password);
    ...
    $mail->Body = '
        ...
        <br>
        ' . '<a href="http://localhost/project/reset.php?email='.$_POST['email']. 
        '&code='.$user->SECURITY_CODE. '">http://localhost/project/reset.php?email='.$_POST['email']. 
